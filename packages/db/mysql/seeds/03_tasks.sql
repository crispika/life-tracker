...
-- 获取目标ID
SET @health_goal_id = (SELECT goal_id FROM UC_GOAL WHERE user_id = @demo_user_id AND summary = '健康管理');
SET @work_goal_id = (SELECT goal_id FROM UC_GOAL WHERE user_id = @demo_user_id AND summary = '职业发展');
SET @relax_goal_id = (SELECT goal_id FROM UC_GOAL WHERE user_id = @demo_user_id AND summary = '休闲娱乐');
...
SET @health_exercise_id = (SELECT goal_id FROM UC_GOAL WHERE user_id = @demo_user_id AND summary = '日常锻炼');
