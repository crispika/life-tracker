...
CREATE TABLE IF NOT EXISTS UC_PROJECT_STATE (
  ...
  user_id INT(8) UNSIGNED NOT NULL COMMENT '所属用户ID',
  name VARCHAR(50) NOT NULL,
  display_name VARCHAR(50) NOT NULL COMMENT '状态名称',
  created_at DATETIME(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
  updated_at DATETIME(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3) ON UPDATE CURRENT_TIMESTAMP(3),
...
) AUTO_INCREMENT=100000 COMMENT='用户自定义项目状态表';
...
CREATE TABLE IF NOT EXISTS PROJECT_STATE_TEMPLATE (
  ...
  name VARCHAR(50) NOT NULL,
  display_name VARCHAR(50) NOT NULL,
  is_default BOOLEAN NOT NULL DEFAULT TRUE COMMENT '是否默认添加给新用户',
  created_at DATETIME(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
  updated_at DATETIME(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3) ON UPDATE CURRENT_TIMESTAMP(3)
) AUTO_INCREMENT=100000 COMMENT='项目状态模板表';
